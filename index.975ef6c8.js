...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_egGIelRxtkDlvS02w1r6p3mNHbz1SUFiWS2aUaon2Ccj6uToXGTmjb975Wttdmo0";
...
function fetchBreeds() {
    ...
    (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds").then((response)=>{
        const breeds = response.data;
        populateBreedSelect(breeds);
    }).catch((error1)=>{
        (0, _notiflixDefault.default).Notify.failure("Error fetching breeds:", error1);
        showError();
    }).finally(()=>{
...
function fetchCatByBreed(breedId) {
    ...
    (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`).then((response)=>{
        const catData = response.data[0];
        displayCatInfo(catData);
    }).catch((error2)=>{
        (0, _notiflixDefault.default).Notify.failure("Error fetching breeds:", error2);
        showError();
    }).finally(()=>{
        loader.style.display = "none";
    });
...
breedSelect.addEventListener("change", ()=>{
    ...
    if (selectedBreedId) fetchCatByBreed(selectedBreedId);
});
fetchBreeds();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
